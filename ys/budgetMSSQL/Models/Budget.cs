    ...
    public class Budget
    {
        ...
        public static string 保存新增预算(cls预算单 sb)
        {
            ...
            try
            {
                ...
                if (sb.预算收支.Count > 0)
                {
                    adp = new SqlDataAdapter("select * from A预算收支 where 1=2", cnn);
                    ds = new DataSet();
                    adp.Fill(ds);
                    tb = ds.Tables[0];
                ...
                if (sb.类型 == 1)
                {
                    ...
                    if (sb.内部转账.Count > 0)
                    {
                        adp = new SqlDataAdapter("select * from A内部转账 where 1=2", cnn);
                        ds = new DataSet();
                        adp.Fill(ds);
                        tb = ds.Tables[0];
                    ...
                    if (sb.预算发票.Count > 0)
                    {
                        adp = new SqlDataAdapter("select * from A预算发票 where 1=2", cnn);
                        ds = new DataSet();
                        adp.Fill(ds);
                        tb = ds.Tables[0];
                ...
                adp = new SqlDataAdapter("select * from A预算 where 1=2", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                dr = tb.NewRow();
        ...
        public static string 保存已有预算(cls预算单 sb)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A预算 where ID='" + sb.ID.ToString() + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                if (tb.Rows.Count < 1)
            ...
            try
            {
                ...
                for (k = 0; k < tb.Rows.Count; k++)
                {
                    ...
                    if (tb.Rows.Count < 2)   //数量多会导致查询死掉，所以只有在查询单条记录时再搜索子数据
                    {
                        ...
                        SqlDataAdapter adpnbzz = new SqlDataAdapter(str1, cnn);
                        ...
                        SqlDataAdapter adpysfp = new SqlDataAdapter(str1, cnn);
                        ...
                        //SqlDataAdapter adpjl = new SqlDataAdapter(str1, cnn);
                        ...
                        SqlDataAdapter adpbg = new SqlDataAdapter(str1, cnn);
                        ...
                        //SqlDataAdapter adpfj = new SqlDataAdapter(str1, cnn);
        ...
        public static string 保存预计收支(string 预算ID, cls预算收支 yssz)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A预算收支 where 预算ID='" + 预算ID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                bool isnew = true;
        ...
        public static string 保存内部转账(string 预算ID, cls内部转账 nbzz)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A内部转账 where 预算ID='" + 预算ID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                bool isnew = true;
        ...
        public static string 保存预算发票(string 预算ID, cls预算发票 ysfp)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A预算发票 where 预算ID='" + 预算ID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                bool isnew = true;
        ...
        public static string 保存实际收支(string 预算ID, cls实际收支 sjsz)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A实际收支 where 预算ID='" + 预算ID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                bool isnew = true;
        ...
        public static string 保存实际收支批量(List<cls预算单> 预算s, cls实际收支 sjsz, string 收入支出)
        {
            ...
            try
            {
                ...
                SqlDataAdapter adp1 = new SqlDataAdapter("select * from A实际收支 where 1=2", cnn);
                ...
                if ((m > 0) && ((预算类型 == "1") | (预算类型 == "批量审批")) && (处理结果 == "同意"))   //预算分解及激励转移
                {
                    try
                    {
                        ...
                        if (tb.Rows.Count > 0)
                        {
                            ...
                            SqlDataAdapter adp1 = new SqlDataAdapter(str1, cnn);
                            DataSet ds1 = new DataSet();
                            adp1.Fill(ds1);
                            DataTable tb1 = ds1.Tables[0];
                            for (i = 0; i < tb.Rows.Count; i++)
                            ...
                            SqlCommandBuilder cbu1 = new SqlCommandBuilder(adp1);
                            try
                            {
                                k = adp1.Update(tb1);
                            }
                            ...
                            SqlDataAdapter adp2 = new SqlDataAdapter(str1, cnn);
                            ...
                            SqlCommandBuilder cbu2 = new SqlCommandBuilder(adp2);
                            try
                            {
                                k = adp2.Update(tb2);
                            }
                        ...
                        if (xiaoshou != "")  //有销售人员
                        {
                            ...
                            SqlDataAdapter adp1 = new SqlDataAdapter("select * from A预算收支 where 1=2", cnn);
                            DataSet ds1 = new DataSet();
                            adp1.Fill(ds1);
                            DataTable tb1 = ds1.Tables[0];
        ...
        public static string 保存激励申请(string ysID, string tjlry, string tjlje, string tjlbl, string tjlbz, string tlrr)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A激励 where 预算ID='" + ysID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                if (tb.Rows.Count < 1)
        ...
        */
        public static string 保存激励申请(string ysID, string tjlry, string tjlje, string tjlbl, string tjlbz, string tlrr)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A激励 where 1=2", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                dr = tb.NewRow();
        ...
        */
        public static int 保存激励审批(string jlID, string ysID, string tspr, string tspjg, string tspyj)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A激励 where ID='" + jlID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                if (tb.Rows.Count < 1)
        ...
        public static List<cls激励> 获取激励记录s(string sWhere)
        {
            ...
            try
            {
                ...
                //str1 = "select * from V激励和预算 " + sWhere + " limit 0,50000";  //Mysql
                SqlDataAdapter adp = new SqlDataAdapter(str1, cnn);
                DataSet ds = new DataSet();
                adp.Fill(ds);
                DataTable tb = ds.Tables[0];
        ...
        public static string 保存变更申请(string ysID, string tbgr, string tbgyy)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A变更 where 1=2", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                dr = tb.NewRow();
        ...
        public static int 保存变更审批(string bgID, string tspr, string tspjg, string tspyj)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A变更 where ID='" + bgID + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                if (tb.Rows.Count < 1)
        ...
        public static string 保存新增附件(string ysID, string 文件名)
        {
            ...
            try
            {
                ...
                adp = new SqlDataAdapter("select * from A预算附件 where 预算ID='" + ysID + "' and 服务器文件名='" + 文件名 + "'", cnn);
                ds = new DataSet();
                adp.Fill(ds);
                tb = ds.Tables[0];
                if (tb.Rows.Count < 1)
        ...
        public static List<cls附件> 获取附件s(string sWhere)
        {
            ...
            try
            {
                ...
                //str1 = "select * from A预算附件 " + sWhere + " limit 0,50000";  //Mysql
                SqlDataAdapter adp = new SqlDataAdapter(str1, cnn);
                DataSet ds = new DataSet();
                adp.Fill(ds);
                DataTable tb = ds.Tables[0];
        ...
        public static int 记录处理过程(string 相关ID, string 相关业务, string 处理人, string 处理结果, string 处理意见)
        {
            ...
            try
            {
                ...
                dr["处理意见"] = 处理意见;
                tb.Rows.Add(dr);
                SqlCommandBuilder cbu = new SqlCommandBuilder(adp);
                try
                {
                    i = adp.Update(tb);
                }
        ...
        public static List<cls消息> 获取消息记录s(string sWhere)
        {
            ...
            try
            {
                ...
                //str1 = "select * from A消息 " + sWhere + " limit 0,5000";  //Mysql
                SqlDataAdapter adp = new SqlDataAdapter(str1, cnn);
                DataSet ds = new DataSet();
                adp.Fill(ds);
                DataTable tb = ds.Tables[0];
        ...
        public static List<cls办理过程> 获取办理过程s(string sWhere)
        {
            ...
            try
            {
                ...
                str1 = "select top 5000 * from A处理过程 " + sWhere;
                //str1 = "select * from A处理过程 " + sWhere + " limit 0,5000";  //Mysql
                SqlDataAdapter adp = new SqlDataAdapter(str1, cnn);
                DataSet ds = new DataSet();
                adp.Fill(ds);
                DataTable tb = ds.Tables[0];
