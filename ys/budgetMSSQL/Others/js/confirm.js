(function ($) {
    ...
    var GenerateCss = function () {
        ...
        $("#mb_tit").css({
            display: 'block', fontSize: '14px', color: '#FFFFFF', padding: '10px 15px',
            backgroundColor: '#001A66', borderRadius: '15px 15px 0 0',
            borderBottom: '1px solid #FFFFFF', fontWeight: 'bold'
        });
        ...
        $("#mb_btn_no").css({ backgroundColor: '#4DA6FF', marginLeft: '20px' });
